...
from tasks.specific.third_tab.first_row import immediate_run_script, immediate_run_kernel

UI_MODULE_DISPLAY_NAME = "01 - Immediate Functions"

# Make sure all imported tasks are copied and named

immediate_run_script = copy_func(immediate_run_script, UI_MODULE_DISPLAY_NAME)
